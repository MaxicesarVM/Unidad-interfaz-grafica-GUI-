...
public class RegistroPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        im_materia = new javax.swing.JMenuItem();
        jm_registro = new javax.swing.JMenu();
        im_inscripcion = new javax.swing.JMenuItem();
        ...
        im_materia.setText("Agregar Materia");
        im_materia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                im_materiaActionPerformed(evt);
            }
        });
        jm_materia.add(im_materia);

        menu_alumnos.add(jm_materia);

        jm_registro.setText("Registro");

        im_inscripcion.setText("Inscripcion");
        im_inscripcion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                im_inscripcionActionPerformed(evt);
            }
        });
        jm_registro.add(im_inscripcion);
    ...
    // Alumnos y materias ya inscriptas
    
    public static HashSet<Alumno> resultadosInscripcion = new HashSet();
    ...
    private void im_materiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_im_materiaActionPerformed
        
        pnld_escritorio.removeAll();
        pnld_escritorio.repaint();
        
        AltaMaterias ventanaMaterias = new AltaMaterias();
        pnld_escritorio.add(ventanaMaterias);
        ventanaMaterias.setVisible(true);
        pnld_escritorio.moveToFront(ventanaMaterias);
        
        
    }//GEN-LAST:event_im_materiaActionPerformed

    private void im_inscripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_im_inscripcionActionPerformed
        
        pnld_escritorio.removeAll();
        pnld_escritorio.repaint();
        
        AltaFormulario ventanaInscripcion = new AltaFormulario();
        pnld_escritorio.add(ventanaInscripcion);
        ventanaInscripcion.setVisible(true);
        pnld_escritorio.moveToFront(ventanaInscripcion);
        
        
        
    }//GEN-LAST:event_im_inscripcionActionPerformed
    ...
    private javax.swing.JMenuItem im_inscripcion;
    private javax.swing.JMenuItem im_materia;
